...
/**
 * This class gives the user the ability to view
 * the video games that are in stock
 */
public class viewGamesGui {
    ...
    /**
     * JFrame Gui for this class
     */
    private JFrame viewGamesFrame;
    /**
     * Text field for entering the title,genre,studio console and exiting
     */
    ...
    /**
     * This method allows the user to search games by
     * a title,genre,studio and console
     */
    ...
    /**
     *
     * @param title displays the title
     * @param genre displays the genre
     * @param studio displays the studio
     * @param console displays the console
     * @throws SQLException when user enters wrong information
     */
